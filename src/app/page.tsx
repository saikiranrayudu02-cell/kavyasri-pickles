      ...
      <main className="flex-1" ref={revealRef}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-6 text-center lg:text-left z-10">
                ...
                <h1 className="animate-fade-in-up stagger-1 font-rounded text-3xl xs:text-4xl sm:text-5xl lg:text-6xl font-bold text-stone-800 tracking-tight leading-[1.10]">
                  <span className="block font-bold tracking-tight text-stone-800">
                    Traditional Taste
                  </span>
        ...
        <section className="py-16 bg-white border-b border-[#ede5d8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-12 reveal-on-scroll">
              ...
              <h2 className="font-rounded text-2xl sm:text-3xl lg:text-4xl font-bold text-stone-800 mt-1 tracking-tight">
                Explore By Category
              </h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 reveal-on-scroll">
              {categories.map((cat) => (
                ...
                >
                  ...
                  <h3 className="font-rounded font-semibold text-sm text-stone-800 group-hover:text-[#9e1b1e] transition-colors">
                    {cat.name}
                  </h3>
        ...
        <section className="py-16 bg-[#faf7f2] border-b border-[#ede5d8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 lg:gap-8 reveal-on-scroll">
        ...
        <section className="py-20 bg-linear-to-b from-[#faf7f2] via-[#f5efe4] to-[#faf7f2] border-b border-[#ede5d8] relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="text-center max-w-2xl mx-auto mb-14 reveal-on-scroll">
              ...
              <h2 className="font-rounded text-3xl sm:text-4xl lg:text-5xl font-bold text-stone-800 tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 reveal-on-scroll">
              ...
              <div className="group relative bg-white/90 backdrop-blur-md p-7 sm:p-8 rounded-2xl border border-stone-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden">
                ...
                <h3 className="font-rounded font-bold text-xl text-stone-800 mb-2 group-hover:text-[#9e1b1e] transition-colors">
                  Homemade Taste
                </h3>
              ...
              <div className="group relative bg-white/90 backdrop-blur-md p-7 sm:p-8 rounded-2xl border border-stone-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden">
                ...
                <h3 className="font-rounded font-bold text-xl text-stone-800 mb-2 group-hover:text-[#d97706] transition-colors">
                  Quality Ingredients
                </h3>
                <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
              ...
              <div className="group relative bg-white/90 backdrop-blur-md p-7 sm:p-8 rounded-2xl border border-stone-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden">
                ...
                <h3 className="font-rounded font-bold text-xl text-stone-800 mb-2 group-hover:text-emerald-700 transition-colors">
                  Traditional Recipes
                </h3>
                <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
              ...
              <div className="group relative bg-white/90 backdrop-blur-md p-7 sm:p-8 rounded-2xl border border-stone-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden">
                ...
                <h3 className="font-rounded font-bold text-xl text-stone-800 mb-2 group-hover:text-orange-600 transition-colors">
                  Freshly Prepared
                </h3>
                <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
              ...
              <div className="group relative bg-white/90 backdrop-blur-md p-7 sm:p-8 rounded-2xl border border-stone-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden">
                ...
                <h3 className="font-rounded font-bold text-xl text-stone-800 mb-2 group-hover:text-sky-700 transition-colors">
                  Hygienically Packed
                </h3>
                <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
              ...
              <div className="group relative bg-white/90 backdrop-blur-md p-7 sm:p-8 rounded-2xl border border-stone-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden">
                ...
                <h3 className="font-rounded font-bold text-xl text-stone-800 mb-2 group-hover:text-purple-700 transition-colors">
        ...
        <section className="py-14 bg-[#fffdfa] border-b border-[#ede5d8]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <h2 className="font-rounded text-2xl sm:text-3xl font-bold text-stone-800 mt-1 tracking-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3">
              {[
                ...
                <div key={item.level} className="p-4 rounded-xl bg-[#faf7f2] border border-stone-200 text-center">
                  ...
                  <h4 className="font-bold text-sm text-stone-800">{item.level}</h4>
        ...
        <section className="py-16 bg-white border-b border-[#ede5d8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-12 reveal-on-scroll">
              ...
              <h2 className="font-rounded text-3xl sm:text-4xl lg:text-5xl font-bold text-stone-800 mt-1 tracking-tight">
              ...
              {[
                ...
                <div key={i} className="p-6 rounded-2xl bg-[#faf7f2] border border-stone-200 flex flex-col justify-between">
                  ...
                  <div className="pt-4 border-t border-stone-200">
                    <div className="font-bold text-xs text-stone-800">{rev.name}</div>
        ...
        <section className="py-16 sm:py-20 bg-[#faf7f2] border-t border-b border-[#ede5d8] relative overflow-hidden">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-5">
            ...
            <h2 className="font-rounded text-3xl sm:text-4xl lg:text-5xl font-bold text-stone-800 tracking-tight leading-tight">
